...
/**
 * Annotation for validate required value. Whitespace is treated for trim target.
 * 
 * 必須を検証するためのアノテーション。
 * 
...
public @interface BlancoValidateRequired {
    /**
     * 選択項目かどうか。この値によりメッセージが変化します。
     * 
     * @return
     */
    boolean isSelection() default false;
}
